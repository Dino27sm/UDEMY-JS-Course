...
(0, _shoppingCartJsDefault.default)("tomato", 8);
(0, _shoppingCartJsDefault.default)("bread", 1);
...
console.log(`Initial value of stateDeepClone logIn: ${stateDeepClone.user.logIn}`);
...
console.log(`After the change of stateDeepClone logIn: ${stateDeepClone.user.logIn}`);
console.log();
...
const cart = []; // EXPORTS NOT the copy of ARRAY but its POINTING ADDRESS
